...
(function (root, factory) {
  ...
  const intents = ['create_invoice', 'update_invoice', 'add_payment', 'create_client', 'update_client', 'create_product', 'update_product', 'delete_record', 'search', 'account_statement', 'dashboard_summary', 'open_page', 'preview_invoice', 'export_pdf', 'export_excel', 'backup', 'help'];
