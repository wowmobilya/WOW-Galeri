const CACHE_NAME = 'wow-furniture-v13-background-activation-fixed';
const urlsToCache = [
  './',
  './index.html',
...
self.addEventListener('fetch', event => {
  ...
  const privateGoogle = url.hostname === 'accounts.google.com' || url.hostname === 'oauth2.googleapis.com' || url.hostname === 'www.googleapis.com' || url.hostname.endsWith('.googleapis.com') || url.hostname === 'wow-background-backup-iay1ii.v2.appdeploy.ai';
